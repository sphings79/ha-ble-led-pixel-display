...
The integration ships **118 pictures**, drawn for a 32×32 panel, 20 of them animated. Nothing to download, no file paths, no `/config/www/`: pick one and it goes to the panel.
...
| **Occasion** | Alarm clock, timer, calendar, birthday, Christmas, Halloween, Easter, snowman, fireworks, bin day |
